...
class Frame2d {
  ...
  friend V2d operator*(const Frame2d &, const V2d &);
 public:
  ...
  V2d get_heading() const;

  V2d get_x_axis() const { return V2d(n_x,n_y); }
  V2d get_y_axis() const { return V2d(-n_y,n_x); }
  V2d get_pos() const { return V2d(p_x,p_y); }
  void set_angle(const Angle&);
  void set_angle(V2d);
  void set_position(double,double);
  void set_position(V2d);
